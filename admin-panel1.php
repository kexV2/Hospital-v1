...
// VULNERABILITY FIX 3: Enforce authentication on admin-panel1 (Broken Access Control)
session_start();
if (!isset($_SESSION['username']) || $_SESSION['username'] !== 'admin') {
    // Not logged in as admin/receptionist – kick them to login page
...
if (isset($_POST['docsub'])) {
  ...
  $query  = "insert into doctb(username,password,email,spec,docFees)
             values('$doctor','$hashedPassword','$demail','$spec','$docFees')";
  ...
  <head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css" integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M" crossorigin="anonymous">
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1" crossorigin="anonymous">
                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      // VULNERABILITY FIX 2: escape doctor fields to prevent stored XSS
                      echo "<tr>
                        <td>".e($username)."</td>
                        <td>".e($spec)."</td>
                        <td>".e($email)."</td>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      // VULNERABILITY FIX 2: escape patient fields to prevent stored XSS
                      echo "<tr>
                        <td>".e($pid)."</td>
                        <td>".e($fname)."</td>
                        <td>".e($lname)."</td>
                ...
                <tbody>
                  <?php 
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      // VULNERABILITY FIX 2: escape prescription-related fields
                      echo "<tr>
                        <td>".e($doctor)."</td>
                        <td>".e($pid)."</td>
                        <td>".e($ID)."</td>
        ...
        <div class="col-md-2"><input type="submit" name="app_search_submit" class="btn btn-primary" value="Search"></div></div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        <!-- VULNERABILITY FIX 2: escape appointment fields -->
                        <td><?php echo e($row['ID']);?></td>
                        <td><?php echo e($row['pid']);?></td>
                        ...
                        <td><?php echo e($row['docFees']);?></td>
                        <td><?php echo e($row['appdate']);?></td>
                        <td><?php echo e($row['apptime']);?></td>
                        <td>
        ...
        <div class="col-md-2"><input type="submit" name="mes_search_submit" class="btn btn-primary" value="Search"></div></div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        <!-- VULNERABILITY FIX 2: escape contact/queries fields -->
