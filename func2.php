...
if (isset($_POST['patsub1'])) {
    ...
    if ($password == $cpassword) {
        ...
        // Store the hash in both password and cpassword columns
        $query = "insert into patreg(fname,lname,gender,email,contact,password,cpassword)
                  values('$fname','$lname','$gender','$email','$contact','$hashed','$hashed')";
        ...
        if ($result) {
            ...
            // get the PID for the new patient
            $query1  = "select pid from patreg where email='$email' limit 1;";
